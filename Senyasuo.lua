...
local version = 1.1
local Author = "柠檬835100765"
local print = function() end;
function Say(text)
	print("<font color=\"#FF0000\"><b>柠檬SAC:</b></font> <font color=\"#FFFFFF\">" .. tostring(text) .. "</font>")
end
...
local UPDATE_PATH = "/bol-Yutti/bol-Scripts/master/Senyasuo.lua".."?rand="..math.random(1,10000)
local UPDATE_FILE_PATH = SCRIPT_PATH..GetCurrentEnv().FILE_NAME
local UPDATE_URL = "https://"..UPDATE_HOST..UPDATE_PATH

if AUTOUPDATE then
	local ServerData = GetWebResult(UPDATE_HOST, "/bol-Yutti/bol-Scripts/master/Senyasuo.version")
	if ServerData then
...
_G.UseUpdater = true
_G.BuffFix = true  -- Set this to true if the script not auto ult 
--------------------------------------------------------------
if _G.BuffFix then
_G.BUFF_NONE = 0
_G.BUFF_GLOBAL = 1
...
function MainMenu()
	...
	YasuoMenu:addTS(ts)
	-- Create SubMenu --
	YasuoMenu:addSubMenu("> 连招设置", "Combo")
    YasuoMenu:addSubMenu("> 骚扰设置", "Harass")
	YasuoMenu:addSubMenu("> 补兵设置", "LaneLH")
	YasuoMenu:addSubMenu("> 清兵设置", "LaneCL")
	YasuoMenu:addSubMenu("> 清野设置", "Jungclear")
	YasuoMenu:addSubMenu("> 击杀设置", "KS")
	YasuoMenu:addSubMenu("> 逃跑设置", "Escape")
	YasuoMenu:addSubMenu("> 翻墙设置", "Walljump")
	YasuoMenu:addSubMenu("> 高级设置", "Advanced")
	YasuoMenu:addSubMenu("> 额外设置", "Extras")
	YasuoMenu:addSubMenu("> 预判设置", "Prediction")	
	YasuoMenu:addSubMenu("> 显示设置", "Draw")
	YasuoMenu:addSubMenu("> 人性设置", "Humanizer")
	YasuoMenu:addSubMenu("> 菜单设置", "PermaShow")
	-- Combo --
	YasuoMenu.Combo:addParam("UseQ", "使用 Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Combo:addParam("UseQ2", "使用 Q2", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Combo:addParam("UseE", "使用 E", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Combo:addParam("UseR", "使用 R", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Combo:addParam("smarte", "使用智能 E ", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Combo:addParam("UseItems", "使用物品", SCRIPT_PARAM_ONOFF, true)
	-- Harass --
	YasuoMenu.Harass:addParam("smartharass", "使用智能骚扰", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Harass:addParam("minrange", "使用E的最小范围", SCRIPT_PARAM_SLICE, 500, 100, 900)
	YasuoMenu.Harass:addParam("maxrange", "使用E最大范围", SCRIPT_PARAM_SLICE, 800, 100, 1300)	
	YasuoMenu.Harass:addParam("UseQ", "使用 Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Harass:addParam("UseQ2", "使用 Q2", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Harass:addParam("UseE", "使用 E", SCRIPT_PARAM_ONOFF, false)
	YasuoMenu.Harass:addParam("LhQ", "使用Q补兵", SCRIPT_PARAM_ONOFF, true)
	-- Lane Last Hit and Clear --
	YasuoMenu.LaneLH:addParam("UseQ", "使用 Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.LaneLH:addParam("UseQ2", "使用 Q2", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.LaneLH:addParam("UseE", "使用 E", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.LaneCL:addParam("UseQ", "使用 Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.LaneCL:addParam("UseQ2", "使用 Q2", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.LaneCL:addParam("UseE", "使用 E", SCRIPT_PARAM_ONOFF, true)
	-- Jungle Clear --
	YasuoMenu.Jungclear:addParam("UseQ", "使用 Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Jungclear:addParam("UseQ2", "使用 Q2", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Jungclear:addParam("UseE", "使用 E", SCRIPT_PARAM_ONOFF, true)
	-- Advanced Menu --
	-- Advanced Q Menu --
	YasuoMenu.Advanced:addSubMenu("Q 设置", "AdvQ")
	YasuoMenu.Advanced.AdvQ:addParam("QSlider", "Q2范围设置", SCRIPT_PARAM_SLICE, 1000, 800, 900, 0)
	YasuoMenu.Advanced.AdvQ:addParam("ultQ", "使用大招Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Advanced.AdvQ:addParam("interruptRecallQ", "使用Q2打断技能", SCRIPT_PARAM_ONOFF, false)
	YasuoMenu.Advanced.AdvQ:addParam("Info", "--- 自动Q设置 --", SCRIPT_PARAM_INFO, "")
	YasuoMenu.Advanced.AdvQ:addParam("LogicQ", "血量低不使用自动Q", SCRIPT_PARAM_ONOFF, true)		
	YasuoMenu.Advanced.AdvQ:addParam("AutoQ", "使用自动Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Advanced.AdvQ:addParam("AutoQ2", "使用自动Q2", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Advanced.AdvQ:addParam("underTower", "塔下使用自动Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Advanced.AdvQ:addParam("ExQ","AOE伤害Q",SCRIPT_PARAM_LIST, 1, {"低","快速"})	
	-- Advanced W Menu --
	YasuoMenu.Advanced:addSubMenu("W 设置", "AdvW")
	YasuoMenu.Advanced.AdvW:addParam("AutoWall", "使用 (W)", SCRIPT_PARAM_ONOFF, true)
	-- Advanced E Menu --
	YasuoMenu.Advanced:addSubMenu("E 设置", "AdvE")
	YasuoMenu.Advanced.AdvE:addParam("Etomouse", "跟随鼠标E", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("E"))	
	YasuoMenu.Advanced.AdvE:addParam("Info", "--- E 设置 ---", SCRIPT_PARAM_INFO, "")
	YasuoMenu.Advanced.AdvE:addParam("useEGap", "使用E接近目标", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Advanced.AdvE:addParam("EGapCheckEnemies", "使用E多个目标 ", SCRIPT_PARAM_SLICE, 1, 1, 5)
	YasuoMenu.Advanced.AdvE:addParam("EGapCheckAllies", "E多个目标接近目标", SCRIPT_PARAM_SLICE, 0, 0, 5)
	YasuoMenu.Advanced.AdvE:addParam("underTower", "自动塔下E", SCRIPT_PARAM_ONOFF, false)
	-- Advanced R Menu --
	YasuoMenu.Advanced:addSubMenu("R 设置", "AdvR")
	YasuoMenu.Advanced.AdvR:addParam("Info", "--- 连招R设置 ---", SCRIPT_PARAM_INFO, "")
	YasuoMenu.Advanced.AdvR:addParam("ComnoRhealth", "血量检查", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Advanced.AdvR:addParam("Health", "血量少于百分比不大招 ", SCRIPT_PARAM_SLICE, 20, 0, 100, -1)	
	YasuoMenu.Advanced.AdvR:addParam("underTower", "塔下R ", SCRIPT_PARAM_ONOFF, false)	 	 	
	YasuoMenu.Advanced.AdvR:addParam("Delay", "使用R的延迟 ", SCRIPT_PARAM_ONOFF, true)
	for i, enemy in ipairs(GetEnemyHeroes()) do
		if enemy ~= nil then
        	YasuoMenu.Advanced.AdvR:addParam(enemy.charName,"使用大招给 "..tostring(enemy.charName),SCRIPT_PARAM_ONOFF,true)
		end
	end	
	YasuoMenu.Advanced.AdvR:addParam("Info", "--- 自动大招设置 ---", SCRIPT_PARAM_INFO, "")
	YasuoMenu.Advanced.AdvR:addParam("AutoR", "敌人被击飞自动R ", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Advanced.AdvR:addParam("underTower2", "在塔下使用R ", SCRIPT_PARAM_ONOFF, false)	
	YasuoMenu.Advanced.AdvR:addParam("xEnemies", "多个敌人被击飞自动R ", SCRIPT_PARAM_SLICE, 2, 1, 5)		
	YasuoMenu.Advanced.AdvR:addParam("myTarget", "自动R智能检测 ", SCRIPT_PARAM_ONOFF, false)
	YasuoMenu.Advanced.AdvR:addParam("AutoRally", "如果身边有队友使用R ", SCRIPT_PARAM_ONOFF, false)
	YasuoMenu.Advanced.AdvR:addParam("xNumber", "多个队友: ", SCRIPT_PARAM_SLICE, 1, 1, 5)
	YasuoMenu.Advanced.AdvR:addParam("xRange", "范围内: ", SCRIPT_PARAM_SLICE, 500, 0, 1000, 1)
	YasuoMenu.Advanced.AdvR:addParam("AutoRhealth", "检查自己血量 ", SCRIPT_PARAM_ONOFF, false)
	YasuoMenu.Advanced.AdvR:addParam("Health2", "自动R自己血量大于百分比 ", SCRIPT_PARAM_SLICE, 20, 0, 100, -1)
	-- Advanced Packet Menu --
	YasuoMenu.Advanced:addSubMenu("封包施法（勿开）: ", "Packets")
	YasuoMenu.Advanced.Packets:addParam("Info", "--- 封包支持技能（请关闭以下支持，不然出错） ---", SCRIPT_PARAM_INFO, "")
	YasuoMenu.Advanced.Packets:addParam("packetsQ", "使用封包 Q", SCRIPT_PARAM_ONOFF, false)
	YasuoMenu.Advanced.Packets:addParam("packetsW", "使用封包 W", SCRIPT_PARAM_ONOFF, false)	
	YasuoMenu.Advanced.Packets:addParam("packetsE", "使用封包 E", SCRIPT_PARAM_ONOFF, false)
	YasuoMenu.Advanced.Packets:addParam("packetsR", "使用封包 R", SCRIPT_PARAM_ONOFF, false)
	-- Extra Menu --
	YasuoMenu.Extras:addParam("AutoLevel", "自动加点",SCRIPT_PARAM_ONOFF, false)
	YasuoMenu.Extras:addParam("StartLv", "选择",SCRIPT_PARAM_LIST, 1, {"QEW","EQW"})	
	YasuoMenu.Extras:addParam("autoPotions1", "自动喝药",SCRIPT_PARAM_ONOFF,true)
	YasuoMenu.Extras:addParam("autoPotions", "血量百分比",SCRIPT_PARAM_SLICE, 60, 1, 100, 0)
	YasuoMenu.Extras:addParam("TS", "目标选择", SCRIPT_PARAM_LIST, 2, { 	 	
		"目标选择器", 	 	
		"默认目标" 	 	
		})
	-- Prediction Menu --
	if VIP_USER then
	    YasuoMenu.Prediction:addParam("mode", "预判选择:", SCRIPT_PARAM_LIST, 1, {"VPrediction","HPrediction"})
	else
	    YasuoMenu.Prediction:addParam("mode", "预判选择:", SCRIPT_PARAM_LIST, 1, {"VPrediction","HPrediction"})
	end
    -- KillSteal --
	YasuoMenu.KS:addParam("KillSteal", "使用自动击杀", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.KS:addParam("UseIgnite", "使用点燃", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.KS:addParam("UseQ", "使用 Q", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.KS:addParam("UseQ2", "使用 Q2", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.KS:addParam("UseE", "使用 E", SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.KS:addParam("UseR", "使用 R", SCRIPT_PARAM_ONOFF, true)
    -- Escape --
    YasuoMenu.Escape:addParam("Mouse", "跟随鼠标", SCRIPT_PARAM_ONOFF, true)
    YasuoMenu.Escape:addParam("StackQ", "逃跑用Q", SCRIPT_PARAM_ONOFF, true)
    -- Walljump --
    YasuoMenu.Walljump:addParam("Enabled", "开启翻墙",  SCRIPT_PARAM_ONOFF, true)
	YasuoMenu.Walljump:addParam("StackQ", "使用Q翻墙", SCRIPT_PARAM_ONOFF, true)
    YasuoMenu.Walljump:addParam("DrawD", "超过距离不显示位置", SCRIPT_PARAM_SLICE, 1500, 0, 10000, 0)		
    YasuoMenu.Walljump:addParam("DrawJ", "显示翻墙点",  SCRIPT_PARAM_ONOFF, false)
    YasuoMenu.Walljump:addParam("DrawL", "显示落地点",  SCRIPT_PARAM_ONOFF, true)
    YasuoMenu.Walljump:addSubMenu("颜色", "Colors")
    YasuoMenu.Walljump.Colors:addParam("JColor", "翻墙点颜色", SCRIPT_PARAM_COLOR, {100, 0, 100, 255})
    YasuoMenu.Walljump.Colors:addParam("LColor", "落地点颜色", SCRIPT_PARAM_COLOR, {100, 255, 255, 0})
    -- Drawings --
    YasuoMenu.Draw:addParam("drawQRange", "显示 (Q) 范围: ", SCRIPT_PARAM_ONOFF, false)
    YasuoMenu.Draw:addParam("drawQ2Range", "显示 (Q2) 范围: ", SCRIPT_PARAM_ONOFF, false)
    YasuoMenu.Draw:addParam("drawWRange", "显示 (W) 范围: ", SCRIPT_PARAM_ONOFF, false)
    YasuoMenu.Draw:addParam("drawERange", "显示 (E) 范围: ", SCRIPT_PARAM_ONOFF, false)
    YasuoMenu.Draw:addParam("drawRRange", "显示 (R) 范围: ", SCRIPT_PARAM_ONOFF, false)
    YasuoMenu.Draw:addParam("drawTarget", "显示当前目标: ", SCRIPT_PARAM_ONOFF, false)
    YasuoMenu.Draw:addParam("LagFree", "线圈优化", SCRIPT_PARAM_ONOFF, false)
    YasuoMenu.Draw:addParam("CL", "优化大小", SCRIPT_PARAM_SLICE, 75, 1, 2000, 0)
	-- Humanizer --
	YasuoMenu.Humanizer:addParam("Edelay", "延迟使用E (毫秒)", SCRIPT_PARAM_SLICE, 0, 0, 1000, 0)
	YasuoMenu.Humanizer:addParam("Wdelay", "延迟使用W (毫秒)", SCRIPT_PARAM_SLICE, 0, 0, 300, 0)
    -- Permashow --
    YasuoMenu.PermaShow:addParam("AutoQ", "显示自动Q提示", SCRIPT_PARAM_ONOFF, true)	
    YasuoMenu.PermaShow:addParam("SmartHarass", "显示智能骚扰提示", SCRIPT_PARAM_ONOFF, true)
    YasuoMenu.PermaShow:addParam("SmartE", "显示智能E提示", SCRIPT_PARAM_ONOFF, true)	
    YasuoMenu.PermaShow:addParam("WallJump", "显示翻墙提示", SCRIPT_PARAM_ONOFF, true)	
    YasuoMenu.PermaShow:addParam("HarassToggleKey", "显示骚扰提示", SCRIPT_PARAM_ONOFF, true)
    YasuoMenu.PermaShow:addParam("UltimateToggleKey", "显示大招模式提示", SCRIPT_PARAM_ONOFF, true)
    -- KeyBindings --
    YasuoMenu:addParam("Info", "--- --- 安静设置 ---", SCRIPT_PARAM_INFO, "")
    YasuoMenu:addParam("ComboKey", "> 连招: ", SCRIPT_PARAM_ONKEYDOWN, false, 32)
    YasuoMenu:addParam("HarassKey", "> 骚扰: ", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("C"))
    YasuoMenu:addParam("HarassToggleKey", "> 骚扰模式: ", SCRIPT_PARAM_ONKEYTOGGLE, false, string.byte("J"))
    YasuoMenu:addParam("UltimateToggleKey", "> 大招模式: ", SCRIPT_PARAM_ONKEYTOGGLE, true, string.byte("T"))
    YasuoMenu:addParam("AutoQKey", "> 自动Q: ", SCRIPT_PARAM_ONKEYTOGGLE, false, string.byte("K"))
    YasuoMenu:addParam("LasthitKey", "> 补兵: ", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("X"))
    YasuoMenu:addParam("ClearKey", "> 打野清兵: ", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("V"))
    YasuoMenu:addParam("EscapeKey", "> 逃跑翻墙: ", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("G"))
    -- Other --
	YasuoMenu:addParam("Lock", "> 集火目标", SCRIPT_PARAM_ONOFF, true)
    YasuoMenu:addParam("Version", "> 版本", SCRIPT_PARAM_INFO, version)
    YasuoMenu:addParam("Author", "> 作者", SCRIPT_PARAM_INFO, Author)
end

function WallMenu()
    YasuoWall = scriptConfig("NB刺客亚索 - 自动W菜单","YasuoWall")
	    YasuoWall:addParam("PMSpell","阻挡技能",SCRIPT_PARAM_ONOFF,true)
        YasuoWall:addParam("BAttack","阻挡特殊攻击",SCRIPT_PARAM_ONOFF,true)
        YasuoWall:addParam("CAttack","阻挡暴击",SCRIPT_PARAM_ONOFF,true)		
				    ...
				    for _, skill in pairs(AddSkillist[enemy.charName].skilladd) do
			            if skill.spelltype ~= spell then
					        if skill["YWall"] and YasuoWall[tostring(skill.spellname)] == nil then
					            YasuoWall:addParam(tostring(skill.spellname),"阻挡 "..tostring(enemy.charName).." Spell "..tostring(skill.spelltype),SCRIPT_PARAM_ONOFF,true)
					        end
						    if skillShield[enemy.charName] ~= nil then
							    ...
							    if skillShield[enemy.charName][spelltype]["YWall"] and YasuoWall[tostring(enemy:GetSpellData(spell).name)] == nil then
							        YasuoWall:addParam(tostring(enemy:GetSpellData(spell).name),"阻挡 "..tostring(enemy.charName).." Spell "..tostring(Spells2[j]),SCRIPT_PARAM_ONOFF,true)
							    end
						    end
					    else
						    if skill["YWall"] and YasuoWall[tostring(skill.spellname)] == nil then
					            YasuoWall:addParam(tostring(skill.spellname),"阻挡 "..tostring(enemy.charName).." Spell "..tostring(Spells2[j]),SCRIPT_PARAM_ONOFF,true)
					        end
                        end							
					end	
				end
...
function DashMenu()
    YasuoDash = scriptConfig("NB刺客亚索 - 躲避设置","YasuoDash")
    YasuoDash:addParam("smartdash","连招使用智能躲避", SCRIPT_PARAM_ONOFF,true)	
        for i,enemy in pairs (GetEnemyHeroes()) do
		    if AddSkillist[enemy.charName] ~= nil then
			    for j,spell in pairs (Spells) do
				    for _, skill in pairs(AddSkillist[enemy.charName].skilladd) do
			            if skill.spelltype ~= spell then
							...
							if shottype > 0 and YasuoDash[tostring(skill.spellname)] == nil then
					            YasuoDash:addParam(tostring(skill.spellname),"躲避 "..tostring(enemy.charName).." 技能 "..tostring(skill.spelltype),SCRIPT_PARAM_ONOFF,true)
						    end
							if skillShield[enemy.charName] ~= nil then
						        enemyspell = enemy:GetSpellData(spell).name
							    spelltype, casttype = getSpellType(enemy, enemyspell)
							    ...
							    if shottype > 0 and YasuoDash[tostring(enemy:GetSpellData(spell).name)] == nil then
							        YasuoDash:addParam(tostring(enemy:GetSpellData(spell).name),"躲避 "..tostring(enemy.charName).." 技能 "..tostring(Spells2[j]),SCRIPT_PARAM_ONOFF,true)
							    end
							end
					    else
					        shottype = skill.shottype
						    if shottype > 0 and YasuoDash[tostring(skill.spellname)] == nil then
					            YasuoDash:addParam(tostring(skill.spellname),"躲避 "..tostring(enemy.charName).." 技能 "..tostring(Spells2[j]),SCRIPT_PARAM_ONOFF,true)
					        end
                        end							
					end	
				end
...
function OrbwalkMenu()
    YasuoOrbwalk = scriptConfig("NB刺客亚索 - 走砍", "YasuoOrbwalker")
	    YasuoOrbwalk:addParam("orbchoice", "选择走砍", SCRIPT_PARAM_LIST, 4, { "SOW", "SxOrbWalk", "MMA", "SAC" })
	    if YasuoOrbwalk.orbchoice == 1 then
		    require "SOW"
		    SOWi = SOW(VP)
		    SOWi:RegisterAfterAttackCallback(AutoAttackReset) 
		    SOWi:LoadToMenu(YasuoOrbwalk)
		    YasuoOrbwalk:addParam("drawrange", "显示 AA 范围", SCRIPT_PARAM_ONOFF, true)
		    YasuoOrbwalk:addParam("drawtarget", "显示目标线圈", SCRIPT_PARAM_ONOFF, true)
		    YasuoOrbwalk:addParam("focustarget", "重点选择的目标", SCRIPT_PARAM_ONOFF, true)
		end
...
function OnTick()
	...
	if Tdashing and Eduration2 then
		Tdashing = false
		Eduration2 = false;
	end
	if Tdashing2 ~= false and Eduration3 then
		Eduration3 = false;
		Tdashing2 = false
	end
...
function Check()
	...
	Q12READY  = (myHero:CanUseSpell(_Q) == READY and ( myHero:GetSpellData(_Q).name == "YasuoQW" or string.lower(myHero:GetSpellData(_Q).name) == "yasuoq2w"))
	print("Qbuffer" .. " " .. GetGameTimer() .. " Qstate" .. (Q12READY ==  false and 0 or 1));
	print("Qbuff " .. myHero:GetSpellData(_Q).name .. myHero:CanUseSpell(_Q) .. READY);
	Q3READY   = (myHero:CanUseSpell(_Q) == READY and string.lower(myHero:GetSpellData(_Q).name) == "yasuoq3w") 
...
function UseVpred()
	YasuoMenu.Prediction:addSubMenu("预判设置", "VPrediction")
	YasuoMenu.Prediction.VPrediction:addParam("info", "Q命中率设置", SCRIPT_PARAM_INFO, "")
	YasuoMenu.Prediction.VPrediction:addParam("Q12Hit", "Q1命中率", SCRIPT_PARAM_SLICE, 2, 1, 3, 0)
	YasuoMenu.Prediction.VPrediction:addParam("Q3Hit", "Q3命中率", SCRIPT_PARAM_SLICE, 2, 1, 3, 0)
	YasuoMenu.Prediction.VPrediction:addParam("blank", "", SCRIPT_PARAM_INFO, "")
	YasuoMenu.Prediction.VPrediction:addParam("info1", "高低:", SCRIPT_PARAM_INFO, "")
	YasuoMenu.Prediction.VPrediction:addParam("info2", "极低 <- 低 = 1  中 = 2  高 = 3 -> 极高", SCRIPT_PARAM_INFO, "")
end
